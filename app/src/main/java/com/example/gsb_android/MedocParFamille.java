...
public class MedocParFamille extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medoc_par_famille);
       ...
       private class JSONAsynchrone extends AsyncTask <String, String, String> {
           ...
           protected void onPreExecute() {
               super.onPreExecute();
               pDialog = new ProgressDialog(MedocParFamille.this);
           ...
           protected String doInBackground(String... strings) {
               ...
               Request request = new Request.Builder().url("http://192.168.1.37/PPE_Android/tousMedicaments.php").build();
           ...
           protected void onPostExecute(String json) {
               ...
               try {
                   ...
                   List<String> typesFamille = null;
                    typesFamille = Medicament.getAllTypeFamille();

                   final ArrayAdapter<String> adapter = new
                           ArrayAdapter<String>(MedocParFamille.this,R.layout.support_simple_spinner_dropdown_item, typesFamille);
                   ...
                   myList.setOnItemClickListener(new AdapterView.OnItemClickListener()
                   {
                       ...
                       public void onItemClick(AdapterView<?> parent, View view, int
                           ...
                           Intent intent = new Intent( MedocParFamille.this, AfficherMedic.class);

                           List<Medicament> list = new ArrayList<Medicament>();
                            list = (ArrayList<Medicament>)oslist;
                           intent.putExtra("TypeRecherche","typeFamille");
                           intent.putExtra("ValeurType", finalTypesFamille.get(+position));
                           intent.putExtra("ListMedic", (Serializable) list);
                           MedocParFamille.this.startActivityForResult( intent, 11);
